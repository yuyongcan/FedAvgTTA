...
class Server(object):
    ...
    def fit(self):
        ...
        for r in range(self.num_rounds):
            ...
            #     'Loss',
            #     {
            #         f"[{self.dataset_name}]_{self.adapt_model.name} C_{self.fraction}, E_{self.local_epochs}, B_{self.batch_size}, IID_{self.iid}": test_loss},
            #     self._round
            # )
            # self.writer.add_scalars(
            #     'Accuracy',
            #     {
            #         f"[{self.dataset_name}]_{self.adapt_model.name} C_{self.fraction}, E_{self.local_epochs}, B_{self.batch_size}, IID_{self.iid}": test_accuracy},
            #     self._round
            # )
            #
